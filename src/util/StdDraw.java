package util; /******************************************************************************
 *  Compilation:  javac nbody2.StdDraw.java
 *  Execution:    java nbody2.StdDraw
 *  Dependencies: none
 *
...
/**
 *  The {@code nbody2.StdDraw} class provides a basic capability for
 *  creating drawings with your programs. It uses a simple graphics model that
 ...
 *  <p>
 *  <b>Getting started.</b>
 *  To use this class, you must have {@code nbody2.StdDraw.class} in your
 *  Java classpath. If you used our autoinstaller, you should be all set.
 *  Otherwise, either download
 *  <a href = "https://introcs.cs.princeton.edu/java/code/stdlib.jar">stdlib.jar</a>
 *  and add to your Java classpath or download
 *  <a href = "https://introcs.cs.princeton.edu/java/stdlib/StdDraw.java">nbody2.StdDraw.java</a>
 ...
 *           nbody2.StdDraw.setPenRadius(0.05);
 *           nbody2.StdDraw.setPenColor(nbody2.StdDraw.BLUE);
 *           nbody2.StdDraw.point(0.5, 0.5);
 *           nbody2.StdDraw.setPenColor(nbody2.StdDraw.MAGENTA);
 *           nbody2.StdDraw.line(0.2, 0.2, 0.8, 0.2);
 *       }
 *   }
 *  </pre>
 ...
 *  The methods {@code nbody2.StdDraw.line()} and {@code nbody2.StdDraw.point()}
 *  draw lines and points; the methods {@code nbody2.StdDraw.setPenRadius()}
 *  and {@code nbody2.StdDraw.setPenColor()} control the line thickness and color.
 *  <p>
 ...
 *  and represented in degrees. For example, {@code nbody2.StdDraw.arc(0.0, 0.0, 1.0, 0, 90)}
 ...
 *   nbody2.StdDraw.filledPolygon(x, y);
 *  </pre>
 *  <p>
 *  <b>Pen size.</b>
 ...
 *  </ul>
 *  <p>
 *  For example, {@code nbody2.StdDraw.setPenRadius(0.025)} makes
 ...
 *  For example, {@code nbody2.StdDraw.setPenColor(nbody2.StdDraw.MAGENTA)} sets the
 ...
 *  For example, {@code nbody2.StdDraw.setCanvasSize(800, 800)}
 ...
 *  leave a small margin, you can call {@code nbody2.StdDraw.setScale(-.05, 1.05)}.
 *  <p>
 ...
 *   nbody2.StdDraw.setFont(font);
 *   nbody2.StdDraw.text(0.5, 0.5, "Hello, World");
 *  </pre>
 *  <p>
 *  <b>Images.</b>
 ...
 *  {@code nbody2.StdDraw.clear(nbody2.StdDraw.LIGHT_GRAY)} clears the canvas to a shade
 *  of gray.
 *  <p>
 ...
 *  <pre>
 *   nbody2.StdDraw.setScale(-2, +2);
 *   nbody2.StdDraw.enableDoubleBuffering();
 *
 *   for (double t = 0.0; true; t += 0.02) {
 *       double x = Math.sin(t);
 *       double y = Math.cos(t);
 *       nbody2.StdDraw.clear();
 *       nbody2.StdDraw.filledCircle(x, y, 0.05);
 *       nbody2.StdDraw.filledCircle(-x, -y, 0.05);
 *       nbody2.StdDraw.show();
 *       nbody2.StdDraw.pause(20);
 *   }
 *  </pre>
 *  <p>
...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    ***************************************************************************/
     ...
     * {@code nbody2.StdDraw.BLACK}, {@code nbody2.StdDraw.BLUE}, {@code nbody2.StdDraw.CYAN},
     * {@code nbody2.StdDraw.DARK_GRAY}, {@code nbody2.StdDraw.GRAY}, {@code nbody2.StdDraw.GREEN},
     * {@code nbody2.StdDraw.LIGHT_GRAY}, {@code nbody2.StdDraw.MAGENTA}, {@code nbody2.StdDraw.ORANGE},
     * {@code nbody2.StdDraw.PINK}, {@code nbody2.StdDraw.RED}, {@code nbody2.StdDraw.WHITE}, and
     * {@code nbody2.StdDraw.YELLOW}.
     *
    ...
    ***************************************************************************/
    ...
    private static Image getImage(String filename) {
        ...
        // in case file is inside a .jar (classpath relative to nbody2.StdDraw)
        if ((icon == null) || (icon.getImageLoadStatus() != MediaTracker.COMPLETE)) {
...
/*
    private static BufferedImage getImage(String filename) {
        ...
        // in case file is inside a .jar (classpath relative to nbody2.StdDraw)
        try {
            URL url = nbody2.StdDraw.class.getResource(filename);
            BufferedImage image = ImageIO.read(url);
            return image;
        } 
        catch (IOException e) {
